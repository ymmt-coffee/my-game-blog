...
class Phase1HugoTests(unittest.TestCase):
    def test_three_article_types_seo_images_and_outputs(self) -> None:
        with tempfile.TemporaryDirectory() as temp_name:
            ...
            self.assertRegex(play_html, r'data-domains="?ymmt-coffee\.github\.io"?')
            ...
            self.assertIn('window.location.hostname!=="ymmt-coffee.github.io"', play_html)
            self.assertIn('window.location.pathname.startsWith("/my-game-blog/")', play_html)
